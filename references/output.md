...
HiAPI `seedream-5.0-pro/text-to-image` image generation is asynchronous:
...
```json
{
  ...
  "outputs": [
    {
      "kind": "file",
      "path": "/absolute/path/to/outputs/seedream-5.0-pro/text-to-image-20260429-154500-1.png"
    }
  ]
}
```
